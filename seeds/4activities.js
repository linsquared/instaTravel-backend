exports.seed = async function (knex) {
  ...
  await knex('activities').insert([
    ...
    },
    {
      ...
      activity_type: 'Landmarks & Historical Buildings',
      cost: 'FREE',
      activity_description: "Explore the beautiful Baroque architecture and fountains in the lively Piazza Navona, one of Rome's most popular squares.",
      activity_image: ''
    },
    {
      ...
      activity_type: 'Historical Landmarks',
      cost: 'FREE',
      activity_description: "Discover the ancient mausoleum turned fortress, Castel Sant'Angelo, which has played a key role in Rome's history.",
      activity_image: ''
    },
    {
    ...
    {
      activity_id: 'rom-0123456789020',
      activity_name: 'Borghese Gallery',
      activity_type: 'Museums',
      cost: 'FREE',
      activity_description: 'Discover an impressive collection of art from famous artists such as Caravaggio and Raphael.',
      activity_image: ''
    },
